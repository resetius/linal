...
if (NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/contrib/umfpack/UMFPACK")
	...
	message(STATUS "${CMAKE_CURRENT_SOURCE_DIR}/contrib/umfpack/UMFPACK not found")
...
if (NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/contrib/umfpack/AMD")
        set(UMFPACK_SOURCE_FOUND 0)
	message(STATUS "${CMAKE_CURRENT_SOURCE_DIR}/contrib/umfpack/AMD not found")
...
if (NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/contrib/umfpack/UFconfig")
        set(UMFPACK_SOURCE_FOUND 0)
	message(STATUS "${CMAKE_CURRENT_SOURCE_DIR}/contrib/umfpack/UFConfig not found")
